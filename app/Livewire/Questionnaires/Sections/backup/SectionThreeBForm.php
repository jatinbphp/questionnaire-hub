                ...
                foreach (getYears() as $year) {
                    ...
                    if (isset($this->questions[167]['ipr_act_trademark_portfolio']) && $this->questions[167]['ipr_act_trademark_portfolio'] === 'Yes') {
                        ...
                        if ($i == 170) {
                            ...
                            $messages["questions.$i.$year.lte"] = "This field must be less than or equal to the total number of granted trademarks (3.14.2).";
                        }
                    }
                }
                $questionId++;
                    ...
                    foreach (getYears() as $year) {
                        ...
                        if (isset($this->questions[172]['ipr_act_design_portfolio']) && $this->questions[172]['ipr_act_design_portfolio'] === 'Yes') {
                            ...
                            if ($i == 176) {
                                ...
                                $messages["questions.$questionId.$year.lte"] = "This field must be less than or equal to the total number of granted designs (3.15.2).";
                            }
                        }
                    }
                }
                ...
                foreach (getYears() as $year) {
                    ...
                    if (isset($this->questions[177]['ipr_act_rights_portfolio']) && $this->questions[177]['ipr_act_rights_portfolio'] === 'Yes') {
                        ...
                        if ($i == 180) {
                            ...
                            $messages["questions.$questionId.$year.lte"] = "This field must be less than or equal to the total number of granted rights (3.16.2).";
                        }
                    }
                }
                $questionId++;
